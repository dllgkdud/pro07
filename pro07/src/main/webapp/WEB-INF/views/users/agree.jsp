...
<jsp:include page="../common/header.jsp"></jsp:include>
	<div class="container">
		<h2>가입약관</h2>
		<div class="agree_ck">
			<input type="checkbox" id="ck3" name="ck" class="check">
			<label for="ck3" class="label">모든 약관에 동의합니다.</label>
		</div>
		<article class="agree">
...
제33조(분쟁의 해결) "회사"는 분쟁이 발생하였을 경우에 "이용자"가 제기하는 정당한 의견이나 불만을 반영하여 적절하고 신속한 조치를 취합니다. 다만, 신속한 처리가 곤란한 경우에 "회사"는 "이용자"에게 그 사유와 처리일정을 통보합니다.		
			...
			<div class="agree_ck">
				<input type="checkbox" id="ck1" name="ck" class="check">
				<label for="ck1" class="label">이용약관에 동의합니다.</label>
			</div>
		<article class="agree">
제1장 총칙
...
③ 법 시행 전에 개인정보를 수집한 개인정보처리자는 기존의 수집목적 범위에도 불구하고 제1항 단서 및 제2항을 준수하기 위하여 새롭게 정보주체의 동의를 받을 목적으로 법 시행 전에 수집한 개인정보를 이용할 수 있다.		
			...
			<div class="agree_ck">
				<input type="checkbox" id="ck2" name="ck" class="check">
				<label for="ck2" class="label">개인정보처리방식에 동의합니다.</label>
			</div>
		<div class="button_grp">
			<a href="${path1 }/users/add" class="button">다음단계</a>
		</div>
	</div>
	<script>
	$("#ck3").click(function(){
