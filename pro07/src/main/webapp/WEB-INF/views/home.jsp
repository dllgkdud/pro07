		        ...
		        <div class="container">
					<div class="carousel-caption">
			            <div class="btn btn-lg btn-dark">
			            	<h6 class="text-start title">뉴포커스</h6>
			            	<p class="content">신임 총영사 임명장 전수식 개최</p>
						</div>
		          	</div>
				</div>
			</a>
			...
			<a href="#">
		        ...
		        <div class="container">
					<div class="carousel-caption">
						<div class="btn btn-lg btn-dark">
			            	<h6 class="text-start title">뉴포커스</h6>
			            	<p class="content">제3차 2030 부산세계박람회 유치교섭 점검회의 개최</p>
		            	</div>
		          	</div>
				</div>
			</a>
        	...
        	<a href="#">
		        ...
		        <div class="container">
					<div class="carousel-caption">
						<div class="btn btn-lg btn-dark">
			            	<h6 class="text-start title">뉴포커스</h6>
			            	<p class="content">‘제4차 여성과 함께하는 평화 국제회의’ 개최</p>
		            	</div>
		          	</div>
				</div>
			</a>
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
	  	<div class="carousel-inner">
	    	<div class="carousel-item active" data-bs-interval="3000">
	      		<a href="https://www.0404.go.kr/callcenter/cacao_advice_service.jsp" target="_blank" title="새창이동">
					<img src="${path1 }/resources/upload/main/20220524023258742.png" class="d-block w-100" alt="국민의 안전과 더 가까워집니다! 영사콜센터 카카오톡 상담서비스">
				</a>
	    	</div>
	    	<div class="carousel-item" data-bs-interval="3000">
	      		<img src="${path1 }/resources/upload/main/20220808045731080.png" class="d-block w-100" alt="장관 외교활동, 박진 외교부장관">
	    	</div>
	    	<div class="carousel-item" data-bs-interval="3000">
	      		<img src="${path1 }/resources/upload/main/20220111111753399.png" class="d-block w-100" alt="코로나19 관련, 각국의 해외입국자에 대한 조치 현황">
	    	</div>
	    	<div class="carousel-item" data-bs-interval="3000">
	      		<img src="${path1 }/resources/upload/main/20220118041911524.png" class="d-block w-100" alt="30초 휙터뷰, 휙터뷰 모아보기 (외교부 휙터뷰)">
	    	</div>
	    	<div class="carousel-item" data-bs-interval="3000">
	      		<img src="${path1 }/resources/upload/main/20220826103558846.png" class="d-block w-100" alt="기타 주요 외교활동, 외교부">
	    	</div>
	    	<div class="carousel-item" data-bs-interval="3000">
	    		<a href="https://www.korea.kr/news/actuallyList.do?pWise=deptlink" target="_blank" title="새창이동">
	      			<img src="${path1 }/resources/upload/main/20221028022744946.png" class="d-block w-100" alt="정부정책, 사실은 이렇습니다. 바로가기">
	      		</a>
	    	</div>
	  	</div>
...
<div class="news">
	<div class="news_tit title my-4">
		<h2 style="font-size:3rem; font-weight:800; text-align:center;">외교부 <span style="color:#917c62;">소식</span></h2>
		<p style="text-align:center;">외교부의 새로운 소식을 만나 보실 수 있습니다.</p>
	</div>
	<div class="news_con container">
		<div class="news_box row mb-3">
			<div class="news_item col-sm">
				<a href="${path1 }/notice/one?no=1">
					<b>공지</b>
					<p>2022년 기록관리기준표 변경사항 고시</p>
					<em>2022.12.30</em>
				</a>
			</div>
			<div class="news_item col-sm">
				<a href="${path1 }/notice/one?no=4">
					<b>공지</b>
					<p>강제징용 해법 논의를 위한 공개토론회 안내</p>
					<em>2022.01.11</em>
				</a>
			</div>
			<div class="news_item col-sm">
				<a href="${path1 }/notice/one?no=5">
					<b>공지</b>
					<p>중국 입국자 대상 검역정보 사전입력시스템(Q-CODE) 이용자 매뉴얼 및 PCR 검사 등록 안내</p>
					<em>2022.01.11</em>
				</a>
			</div>
		</div>
...
<div class="sns">
	<div class="news_tit title my-4">
		<div class="news_info mb-3">
			<h2 style="font-size:3rem; font-weight:800; text-align:center;">외교부 <b>누리소통망</b></h2>
			<p style="text-align:center;">외교부의 새로운 소식을 만나 보실 수 있습니다.</p>
		</div>
		<div class="news_box row justify-content-md-center mb-3">
			<div class="news_item center col-md-1">
				<a href="https://www.instagram.com/mofa_kr/" target="_blank" title="새창" class="insta">
	      			<img src="${path1 }/resources/upload/main/icon_sns_ist.png" alt="인스타그렘">
				</a>
			</div>
	      	<div class="news_item center col-md-1">
	      		<a href="https://www.facebook.com/mofakr.kr" target="_blank" title="새창" class="facebook">
	      			<img src="${path1 }/resources/upload/main/icon_sns_fb.png" alt="페이스북">
	      		</a>
	      	</div>
	      	<div class="news_item center col-md-1">
	      		<a href="https://twitter.com/mofa_kr" target="_blank" title="새창" class="twitter">
	      			<img src="${path1 }/resources/upload/main/icon_sns_tw.png" alt="트위터">
	      		</a>
	      	</div>
	      	<div class="news_item center col-md-1">
	      		<a href="https://blog.naver.com/mofakr" target="_blank" title="새창" class="blog">
	      			<img src="${path1 }/resources/upload/main/icon_sns_nb.png" alt="블로그">
	      		</a>
	      	</div>
	      	<div class="news_item center col-md-1">
	      		<a href="https://www.youtube.com/user/MOFAKorea" target="_blank" title="새창" class="youtube">
	      			<img src="${path1 }/resources/upload/main/icon_sns_ytb.png" alt="유튜브">
	      		</a>
	      	</div>
	      	<div class="news_item col-md-1">
	      		<a href="https://linktr.ee/mofa_koreaz" target="_blank" title="새창" class="koreaz">
	      			<img src="${path1 }/resources/upload/main/txt_koreaz.png" alt="koreaz">
	      		</a>
	      	</div>
		</div>
	</div>
